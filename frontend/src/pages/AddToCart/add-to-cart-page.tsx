...
const AddToCart = () => {
  ...
  return (
    <div className="container mx-auto py-[52px] lg:py-[92px]">
        ...
        <div className="flex-grow">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end">
            <div className="mb-4 md:mb-0">
              <a
                href="/shop"
                className="text-lg lg:text-xl font-bold flex items-center gap-2"
              >
                <FaChevronLeft className="text-lg lg:text-xl font-bold" />{" "}
                Continue Shopping
              </a>
            </div>
